...
├── desktop/                # Desktop app bundling (PyInstaller)
│   └── launcher.py         # Desktop app launcher
├── pwa/                    # Progressive Web App landing page
│   └── index.html          # Branded landing page with server detection
├── README.md               # User documentation
└── .env                    # Environment variables (optional, settings.py preferred)
```
